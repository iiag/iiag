...
*/
	...
	//expect(tree3!=NULL);
	//expect(*(int *)(tree3->data)==*(int *)(stuff+1));
	...
	expect(tree4!=NULL);
	expect(*(double *)tree4->data=*(double *)stuff3+3);

	map_func(tree2, &sum2, (func)sumify_double);
	fprintf(stderr, "sum2: %f expected sum2: %f\n",sum2, 1.2329 + 101.0282 + 200.1092 + 40.0982 + 4.0929);
	expect(sum2 == 1.2329 + 200.1092 + 2.0982 + 101.0282 + 40.9827);
/*
